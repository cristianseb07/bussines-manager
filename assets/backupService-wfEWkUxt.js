const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./index-Bdp2TIFD.js","./index-BrvtISWL.css"])))=>i.map(i=>d[i]);
import { D as Dexie, _ as __vitePreload, d as db } from "./index-Bdp2TIFD.js";
import { r as registerPlugin, C as Capacitor } from "./index-D-Ubi8Nr.js";
import { F as Filesystem, D as Directory, S as Share } from "./index-Dt479MX5.js";
...
const backupService = {
  ...
  async syncToCloud(uid) {
    try {
      ...
      await __vitePreload(() => import("./index-Bdp2TIFD.js").then((n) => n.m), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url).then((m) => m.supabaseService.uploadBackup(uid, fileName, blob));
  ...
  async listCloudBackups(uid) {
    try {
      const { supabaseService } = await __vitePreload(async () => {
        const { supabaseService: supabaseService2 } = await import("./index-Bdp2TIFD.js").then((n) => n.m);
