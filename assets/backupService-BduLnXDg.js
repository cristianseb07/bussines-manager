import { D as Dexie, _ as __vitePreload, d as db } from "./index-DTZBx3tV.js";
import { r as registerPlugin, C as Capacitor } from "./index-D-Ubi8Nr.js";
import { F as Filesystem, D as Directory, S as Share } from "./index-DeK-ZssG.js";
...
const backupService = {
  ...
  async syncToCloud(uid) {
    try {
      ...
      await __vitePreload(() => import("./index-DTZBx3tV.js").then((n) => n.m), true ? [] : void 0, import.meta.url).then((m) => m.supabaseService.uploadBackup(uid, fileName, blob));
  ...
  async listCloudBackups(uid) {
    try {
      const { supabaseService } = await __vitePreload(async () => {
        const { supabaseService: supabaseService2 } = await import("./index-DTZBx3tV.js").then((n) => n.m);
