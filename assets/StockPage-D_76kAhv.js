const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./index-Dt479MX5.js","./index-Bdp2TIFD.js","./index-BrvtISWL.css","./index-D-Ubi8Nr.js"])))=>i.map(i=>d[i]);
import { c as createLucideIcon, b as useAuth, a as useLiveQuery, r as reactExports, e as useSearchParams, f as useLocation, j as jsxRuntimeExports, g as reactDomExports, P as Package, d as db, _ as __vitePreload } from "./index-Bdp2TIFD.js";
import { D as Download, d as downloadTemplate, p as parseExcelFile, e as executeBulkImport, a as exportDataToExcel } from "./excel-vI3FYDe5.js";
import { P as Plus } from "./plus-NMoDvQPh.js";
import { D as DollarSign } from "./dollar-sign-DDZzqGeG.js";
import { T as TriangleAlert } from "./triangle-alert-Cpbgu4JT.js";
import { T as Trash2, X, P as PenLine } from "./x-Kdml5EhN.js";
import { S as Search } from "./search-NS2E6JsK.js";
import { I as Image } from "./image-BCzGk3Gl.js";
import "./index-D-Ubi8Nr.js";
import "./index-Dt479MX5.js";
const __iconNode = [
  [
    "path",
    {
...
`;
      ...
      if (options.image && product.photo && product.photo.startsWith("data:image")) {
        const { Filesystem, Directory } = await __vitePreload(async () => {
          const { Filesystem: Filesystem2, Directory: Directory2 } = await import("./index-Dt479MX5.js").then((n) => n.i);
      ...
      const { Share } = await __vitePreload(async () => {
        const { Share: Share2 } = await import("./index-Dt479MX5.js").then((n) => n.a);
        return { Share: Share2 };
      }, true ? __vite__mapDeps([0,1,2,3]) : void 0, import.meta.url);
