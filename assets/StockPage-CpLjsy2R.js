const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./index-DGKC6dK7.js","./index-D9QyKrJY.js","./index-D-Ubi8Nr.js"])))=>i.map(i=>d[i]);
import { c as createLucideIcon, b as useAuth, a as useLiveQuery, r as reactExports, e as useSearchParams, f as useLocation, j as jsxRuntimeExports, g as reactDomExports, P as Package, d as db, _ as __vitePreload } from "./index-D9QyKrJY.js";
import { D as Download, d as downloadTemplate, p as parseExcelFile, e as executeBulkImport, a as exportDataToExcel } from "./excel-B8ruCkI1.js";
import { P as Plus } from "./plus-B30U1fcI.js";
import { D as DollarSign } from "./dollar-sign-c9Xb33ts.js";
import { T as TriangleAlert } from "./triangle-alert-By-IlrZz.js";
import { T as Trash2, X, P as PenLine } from "./x-BNb926bc.js";
import { S as Search } from "./search-B6na_FjB.js";
import { I as Image } from "./image-lTozXinQ.js";
import "./index-D-Ubi8Nr.js";
import "./index-DGKC6dK7.js";
const __iconNode = [
  [
    "path",
    {
...
`;
      ...
      if (options.image && product.photo && product.photo.startsWith("data:image")) {
        const { Filesystem, Directory } = await __vitePreload(async () => {
          const { Filesystem: Filesystem2, Directory: Directory2 } = await import("./index-DGKC6dK7.js").then((n) => n.i);
      ...
      const { Share } = await __vitePreload(async () => {
        const { Share: Share2 } = await import("./index-DGKC6dK7.js").then((n) => n.a);
        return { Share: Share2 };
      }, true ? __vite__mapDeps([0,1,2]) : void 0, import.meta.url);
