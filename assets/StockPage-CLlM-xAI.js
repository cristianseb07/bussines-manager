const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./index-B2mSapSJ.js","./index-BbO_2nLg.js","./index-D-Ubi8Nr.js"])))=>i.map(i=>d[i]);
import { c as createLucideIcon, b as useAuth, a as useLiveQuery, r as reactExports, e as useSearchParams, f as useLocation, j as jsxRuntimeExports, g as reactDomExports, P as Package, d as db, _ as __vitePreload } from "./index-BbO_2nLg.js";
import { D as Download, d as downloadTemplate, p as parseExcelFile, e as executeBulkImport, a as exportDataToExcel } from "./excel-NCvEsed_.js";
import { P as Plus } from "./plus-BzUks2v0.js";
import { D as DollarSign } from "./dollar-sign-M_v__TPm.js";
import { T as TriangleAlert } from "./triangle-alert-BQyIGBKS.js";
import { T as Trash2, X, P as PenLine } from "./x-BeblcN_0.js";
import { S as Search } from "./search-D-3R_Zqc.js";
import { I as Image } from "./image-xNQ56IY_.js";
...
`;
      ...
      if (options.image && product.photo && product.photo.startsWith("data:image")) {
        const { Filesystem, Directory } = await __vitePreload(async () => {
          const { Filesystem: Filesystem2, Directory: Directory2 } = await import("./index-B2mSapSJ.js").then((n) => n.i);
      ...
      const { Share } = await __vitePreload(async () => {
        const { Share: Share2 } = await import("./index-B2mSapSJ.js").then((n) => n.a);
        return { Share: Share2 };
      }, true ? __vite__mapDeps([0,1,2]) : void 0, import.meta.url);
